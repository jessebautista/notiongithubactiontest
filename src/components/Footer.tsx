  ...
  return (
    <footer className="bg-gray-900 text-white">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-xl font-bold">IntelliAgent Solutions</span>
              </div>

              <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
                Transforming businesses with intelligent AI agents. We make advanced artificial intelligence 
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400">
                Get the latest insights on AI agents and automation trends delivered to your inbox.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-500 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-300 whitespace-nowrap"
              >
                Subscribe
              </motion.button>
            </div>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} IntelliAgent Solutions. All rights reserved.
            </div>
      ...
      <motion.button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary-600 text-white rounded-full shadow-lg hover:bg-primary-700 transition-colors duration-200 flex items-center justify-center z-50"
